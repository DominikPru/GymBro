    ...
    <div className="sidebar">
      ...
      <div className="main-menu">
        <div
          ...
          className={selectedIndex == 0 ? "menu-item active" : "menu-item"}
        >
          <a>
        ...
        <div
          ...
          className={selectedIndex == 1 ? "menu-item active" : "menu-item"}
        >
          <a>
        ...
        <div
          ...
          className={selectedIndex == 2 ? "menu-item active" : "menu-item"}
        >
          <a>
        ...
        <div
          ...
          className={selectedIndex == 3 ? "menu-item active" : "menu-item"}
        >
          <a>
        ...
        <div
          ...
          className={selectedIndex == 4 ? "menu-item active" : "menu-item"}
        >
          <a>
        ...
        <div
          ...
          className={selectedIndex == 5 ? "menu-item active" : "menu-item"}
        >
          <a>
